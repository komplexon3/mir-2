...
import (
	...
	basemodule "github.com/filecoin-project/mir/samples/broadcast/customattacks/doublesigattack/baseModule"
	byzmodule "github.com/filecoin-project/mir/samples/broadcast/customattacks/doublesigattack/byzModule"
...
func run() error {
	...
	if args.OwnID == "0" {
		broadcastModule = byzmodule.NewBroadcast(
			byzmodule.ModuleParams{
				NodeID:   args.OwnID,
				AllNodes: nodeIDs,
			},
			byzmodule.ModuleConfig{
				Self:     "broadcast",
				Consumer: "control",
				Net:      "net",
				Crypto:   "crypto",
		...
		broadcastModule = basemodule.NewBroadcast(
			basemodule.ModuleParams{
				NodeID:   args.OwnID,
				AllNodes: nodeIDs,
			},
