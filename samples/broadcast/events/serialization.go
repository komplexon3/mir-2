...
const (
	BroadcastRequestEvent = "BroadcastRequest"
...
func Deserialize(data []byte) (stdtypes.Event, error) {
	...
	switch se.EvType {
	case BroadcastRequestEvent:
		e = &BroadcastRequest{baseEvent: baseEvent{Metadata: make(map[string]interface{})}}
	case DeliverEvent:
