...
const (
	GrpcTransport_Listen_FullMethodName = "/grpctransport.GrpcTransport/Listen"
)
...
func (c *grpcTransportClient) Listen(ctx context.Context, opts ...grpc.CallOption) (GrpcTransport_ListenClient, error) {
	stream, err := c.cc.NewStream(ctx, &GrpcTransport_ServiceDesc.Streams[0], GrpcTransport_Listen_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
